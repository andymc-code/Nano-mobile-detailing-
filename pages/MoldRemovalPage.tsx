...
const MoldRemovalPage: React.FC = () => {
    const pageTitle = 'Car Mold Removal Vancouver | Nano Mobile';
            ...
            <div className="container mx-auto px-6 py-16">
                ...
                <div className="grid lg:grid-cols-5 gap-12">
                    <div className="lg:col-span-3">
                        <h2 className="text-3xl font-bold font-display text-white mb-4 uppercase tracking-tighter">PROTECT YOUR HEALTH. <span className="text-brand-gold">RESTORE YOUR CAR.</span></h2>
                        ...
                        <h3 className="text-2xl font-semibold font-display text-white mt-10 mb-6 tracking-widest uppercase">OUR MOLD REMEDIATION PROCESS:</h3>
                    ...
                    <div className="lg:col-span-2">
                        <img src="https://ik.imagekit.io/wnwu0xxx5/Auto_detailing/Interior%20Restoration_card.png" alt="A clean and restored car interior" className="rounded-2xl shadow-xl object-cover h-full w-full border border-brand-border" />
                    </div>
                </div>

                <div className="mt-24 border-t border-brand-border pt-24">
                    <h2 className="text-3xl font-bold font-display text-white text-center mb-10 uppercase tracking-tighter">Mold <span className="text-brand-gold">Eradication FAQs</span></h2>
