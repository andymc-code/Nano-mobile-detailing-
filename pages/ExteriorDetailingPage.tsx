...
const ExteriorDetailingPage: React.FC = () => {
    const pageTitle = 'Exterior Car Detailing Vancouver | Nano Mobile';
            ...
            <div className="container mx-auto px-6 py-16">
                ...
                <div className="grid lg:grid-cols-5 gap-12">
                    <div className="lg:col-span-3">
                        <h2 className="text-3xl font-bold font-display text-white mb-4 uppercase tracking-tighter">A LUSTROUS, PROTECTED FINISH. <span className="text-brand-gold">DELIVERED.</span></h2>
                        ...
                        <h3 className="text-2xl font-semibold font-display text-white mt-10 mb-6 tracking-widest uppercase">WHAT'S INCLUDED:</h3>
                    ...
                    <div className="lg:col-span-2">
                        <img src="https://ik.imagekit.io/wnwu0xxx5/Auto_detailing/ford_raptor_after_exterior_detail.png?updatedAt=1759708679669" alt="Ford Raptor with a clean exterior" className="rounded-2xl shadow-xl object-cover h-full w-full border border-brand-border" />
                    </div>
                </div>

                <div className="mt-24 border-t border-brand-border pt-24">
                    <h2 className="text-3xl font-bold font-display text-white text-center mb-10 uppercase tracking-tighter">Exterior <span className="text-brand-gold">Care FAQs</span></h2>
