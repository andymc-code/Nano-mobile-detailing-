...
const FleetDetailingPage: React.FC = () => {
    const pageTitle = 'Fleet Detailing Service Vancouver | Nano Mobile';
            ...
            <div className="container mx-auto px-6 py-16">
                ...
                <div className="grid lg:grid-cols-5 gap-12">
                    <div className="lg:col-span-3">
                        <h2 className="text-3xl font-bold font-display text-white mb-4 uppercase tracking-tighter">A CLEAN FLEET IS <span className="text-brand-gold">GOOD BUSINESS.</span></h2>
                        ...
                        <h3 className="text-2xl font-semibold font-display text-white mt-10 mb-6 tracking-widest uppercase">OUR FLEET SERVICES INCLUDE:</h3>
                    ...
                    <div className="lg:col-span-2">
                        <img src="https://images.unsplash.com/photo-1599599810624-91f13b15b399?q=80&w=2670&auto=format&fit=crop" alt="A clean white commercial van" className="rounded-2xl shadow-xl object-cover h-full w-full border border-brand-border" />
                    </div>
                </div>

                <div className="mt-24 border-t border-brand-border pt-24">
                    <h2 className="text-3xl font-bold font-display text-white text-center mb-10 uppercase tracking-tighter">Fleet <span className="text-brand-gold">Logic FAQs</span></h2>
