...
const OdorEliminationPage: React.FC = () => {
    const pageTitle = 'Car Odor Elimination Vancouver | Nano Mobile';
            ...
            <div className="container mx-auto px-6 py-16">
                ...
                <div className="grid lg:grid-cols-5 gap-12">
                    <div className="lg:col-span-3">
                        <h2 className="text-3xl font-bold font-display text-white mb-4 uppercase tracking-tighter">BREATHE EASY. <span className="text-brand-gold">DRIVE FRESH.</span></h2>
                    ...
                    <div className="lg:col-span-2">
                        <img src="https://ik.imagekit.io/wnwu0xxx5/Auto_detailing/Odor_Elimination.png" alt="Pristine and clean car interior dashboard" className="rounded-2xl shadow-xl object-cover h-full w-full border border-brand-border" />
                    </div>
                </div>

                <div className="mt-24 border-t border-brand-border pt-24">
                    <h2 className="text-3xl font-bold font-display text-white text-center mb-10 uppercase tracking-tighter">Odor <span className="text-brand-gold">Control FAQs</span></h2>
